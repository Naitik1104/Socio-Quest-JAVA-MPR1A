    ...
    public LeaderboardPanel(String loggedInUsername) {
        ...
        leaderboardTable = new JTable(tableModel) {
            ...
            public Component prepareRenderer(javax.swing.table.TableCellRenderer renderer, int row, int column) {
                ...
                String username = (String) getValueAt(row, 1);  
        ...
        leaderboardTable.getTableHeader().setBackground(new Color(34, 49, 40)); 
        leaderboardTable.getTableHeader().setForeground(Color.WHITE); 
        leaderboardTable.setGridColor(new Color(200, 255, 200)); 
        ...
        refreshButton.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18)); 
        ...
        buttonPanel.setBackground(new Color(34, 49, 40)); 
